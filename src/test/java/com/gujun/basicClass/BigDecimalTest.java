...
public class BigDecimalTest {
    ...
    //推荐使用数字字符串作为构造器参数；如果必须通过浮点数参数来创建BigDecimal对象，则应该通过静态方法valueOf(double)来获取实例；
    @Test
    public void test02(){
        System.out.println(Arith.add(0.05,0.01)+"");    //0.06
        System.out.println(Arith.div(0.5,0.3));
        System.out.println(Arith.mul(0.10,0.12));
        System.out.println(Arith.add(0.0045,0.0045));
    }
